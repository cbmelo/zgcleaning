           ...
           <div class="flex gap-2">
                <div class="w-[70%] border border-gray-500">
                    ...
                    <form @submit.prevent="handleBooking">
                        ...
                        <div class="flex -mx-3 mb-6">
                            ...
                            <input 
                                ...
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-3 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Doe">
                            </div>
                    ...
                    <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <label class="block w-full px-3 mb-3">
                                <span class="text-gray-700 font-bold">How Often:</span>
                            </label>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-4 w-full md:w-full px-3 mb-6 md:mb-0 p-4 flex justify-between items-center">  
                ...
                <div class="w-[30%] border border-gray-500">
                    <div class="text-black bg-[#00B8E0] text-white ml-4 p-4 rounded-lg border-gray-150 border">
